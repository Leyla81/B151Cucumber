...
public class Hooks {
   ...
   */
    @Before //importlar junit degil de io.cucumber.java.Before dan gelecek
    public void setUp1() throws Exception {
        System.out.println("Scenario lar calismaya basladı");
   ...
   */
    ...
    @After//importlar junit degil de io.cucumber.java.After dan gelecek
    public void tearDown(Scenario scenario) throws Exception {
        if (scenario.isFailed()){//--->scenario fail olursa
            TakesScreenshot takesScreenshot = (TakesScreenshot) Driver.getDriver();
            scenario.attach(takesScreenshot.getScreenshotAs(OutputType.BYTES),"image/jpeg","scenario_"+scenario.getName());
...
// BURDAKİ METHODLAR RUNNER CLASINDAN CALISTI
